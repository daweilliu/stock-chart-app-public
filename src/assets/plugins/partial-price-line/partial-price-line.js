...
function d(t, i, e = 1, r) {
  const s = Math.round(i * t), o = Math.round(e * i), n = _(o);
...
class p {
  ...
  draw(i) {
    i.useBitmapCoordinateSpace((e) => {
      ...
      const r = Math.round(this._x * e.horizontalPixelRatio), s = d(this._price, e.verticalPixelRatio, e.verticalPixelRatio), o = s.position + s.length / 2, n = e.context;
