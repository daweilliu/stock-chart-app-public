...
var a = (o, e, t) => y(o, typeof e != "symbol" ? e + "" : e, t);
const R = [
  new Path2D(
...
function v(o, e, t = 1, i) {
  const s = Math.round(e * o), r = Math.round(t * e), n = z(r);
...
class p extends P {
  ...
  _drawAlertLines(e) {
    var i;
    if (!((i = this._data) != null && i.alerts)) return;
  ...
  _drawAlertIcons(e) {
    var s;
    if (!((s = this._data) != null && s.alerts)) return;
  ...
  _drawAlertLabel(e) {
    var h;
    if (!((h = this._data) != null && h.alerts)) return;
  ...
  _drawLabel(e, t) {
    ...
    try {
      ...
      const s = v(
        ...
        e.verticalPixelRatio,
        t.labelHeight
      ), r = (t.width - 22) * e.horizontalPixelRatio;
      i.roundRect(
        r,
        s.position,
        21 * e.horizontalPixelRatio,
        s.length,
        A(t.roundedCorners, e.horizontalPixelRatio)
...
class V extends P {
  ...
  _drawCrosshairLabel(e) {
    var i;
    if (!((i = this._data) != null && i.crosshair)) return;
    const t = e.context;
    try {
...
class F extends W {
  ...
  _isHoveringRemoveButton(t, i, s, r) {
    if (!t || !i || Math.abs(t.y - s) > 20 / 2) return !1;
