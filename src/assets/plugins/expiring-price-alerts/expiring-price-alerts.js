...
var a = (n, t, i) => w(n, typeof t != "symbol" ? t + "" : t, i);
import { MismatchDirection as d, LineSeries as v } from "lightweight-charts";
const g = {
  interval: 60 * 60 * 24,
  clearTimeout: 3e3
};
...
function P(n, t, i = 1, s) {
  const e = Math.round(t * n), r = Math.round(i * t), h = C(r);
  ...
  draw(t) {
    ...
    t.useBitmapCoordinateSpace((s) => {
      ...
      e.lineWidth = 2, this._data.forEach((r) => {
        const h = P(r.priceY, i, e.lineWidth), o = (h.position + h.length / 2) / i;
...
class b {
  constructor(t) {
    a(this, "_source");
    a(this, "_renderer");
    this._source = t, this._renderer = new E();
  }
  renderer() {
  ...
  update() {
    ...
    if (i)
      for (const e of this._source._alerts.values()) {
        ...
        h || (h = 0), o || (o = i.width());
        let c = "#000000", l = _;
        e.parameters.crossingDirection === "up" ? (c = e.crossed ? "#386D2E" : e.expired ? "#30472C" : "#64C750", l = e.crossed ? p : e.expired ? f : _) : e.parameters.crossingDirection === "down" && (c = e.crossed ? "#7C1F3E" : e.expired ? "#4A2D37" : "#C83264", l = e.crossed ? p : e.expired ? f : S), t.push({
          priceY: r,
          startX: h,
          endX: o,
          icon: l,
...
class M extends x {
  constructor(i) {
    ...
    a(this, "_source");
    a(this, "_views");
    this._source = i, this._views = [new b(this._source)];
  }
  requestUpdate() {
    super.requestUpdate();
  }
...
class L {
  constructor(t, i) {
    ...
    this._series = t, this._options = {
      ...g,
      ...i
    }, this._primitive = new M(this), this._series.attachPrimitive(this._primitive), this._dataChangedHandler = this._dataChanged.bind(this), this._series.subscribeDataChanged(this._dataChangedHandler);
    const s = this._series.dataByIndex(
      1e4,
      d.NearestLeft
    );
    s && this.checkedCrossed(s), this._chart = this._primitive.chart, this._whitespaceSeries = this._chart.addSeries(v);
  }
  destroy() {
