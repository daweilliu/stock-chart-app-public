...
declare class ExpiringPriceAlertsPaneRenderer implements IPrimitivePaneRenderer {
	_data: RendererDataItem[];
	draw(target: CanvasRenderingTarget2D): void;
	update(data: RendererDataItem[]): void;
}
declare class ExpiringPriceAlertsPaneView implements IPrimitivePaneView {
